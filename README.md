...
### Sellers (Merchants)
- Dedicated **Merchant Dashboard** to:
  - Manage digital storefronts and product catalogs.
  - Update inventory in real time.
  - Process incoming orders with custom notes and status updates.

### Admins
- **System Control Panel** to:
  - Configure platform-wide settings.
  - Audit listed stores and products.
  - Oversee merchant onboarding and verification.
...
The platform ships with a **no-code Admin UI Editor** so non-technical owners can fully control the look and feel:

- Update **Navbar** titles, subtitles, and primary CTAs.  
- Edit **Hero section** headings, subheadings, and highlighted tags.  
...
- **Privacy Controls**:
  - Admins and Sellers can toggle stores or products as **Public** or **Private** for controlled visibility.  
